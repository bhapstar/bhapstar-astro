...
<!-- Generated by scripts/generate-downloads.py. Do not edit this file by
     hand. Every build overwrites it. Edit that script, or the "download" block in site-data.json instead. -->
<html lang="en">
<head>
  <meta charset="utf-8" />
